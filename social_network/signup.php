...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<center><h1 style="color: white;">Social Media Site</h1></center>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Join Social Media Site</strong></h3>
				<hr>
			</div>
			<div class="l-part">
				<form action="" method="post">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <span class="form-check-label" for="inlineRadio2">Other</span>
                    </div>
					</div><br>
					<div class="input-group">
